...
import { Button, Form, Input, Select, Typography, Card, Row, Col, Space, Modal } from 'antd';
...
const IELTSPage = () => {
  ...
  return (
    <Container>
      <Header>
        <Title level={1} style={{ color: '#fff', margin: 0 }}>IELTS</Title>
      </Header>
      <Content>
        <ImageSection>
        ...
        <Space direction="vertical" size="large">
          <Title level={2}>IELTS Test Details</Title>
          <Paragraph>
        ...
        <Modal
          ...
          okText="OK"
        >
          <p>Your request has been recorded in the system. You will receive a language skill assessment query in the future. Thank you.</p>
        </Modal>
      </Content>
    </Container>
  );
